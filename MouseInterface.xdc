...
# 7Seg display 
set_property PACKAGE_PIN W7 [get_ports 7SEGLIGHT[0]]                    
    set_property IOSTANDARD LVCMOS33 [get_ports 7SEGLIGHT[0]]
set_property PACKAGE_PIN W6 [get_ports 7SEGLIGHT[1]]     
    set_property IOSTANDARD LVCMOS33 [get_ports 7SEGLIGHT[1]]
set_property PACKAGE_PIN U8 [get_ports 7SEGLIGHT[2]]     
    set_property IOSTANDARD LVCMOS33 [get_ports 7SEGLIGHT[2]]
set_property PACKAGE_PIN V8 [get_ports 7SEGLIGHT[3]]     
    set_property IOSTANDARD LVCMOS33 [get_ports 7SEGLIGHT[3]]
set_property PACKAGE_PIN U5 [get_ports 7SEGLIGHT[4]]              
    set_property IOSTANDARD LVCMOS33 [get_ports 7SEGLIGHT[4]]
set_property PACKAGE_PIN V5 [get_ports 7SEGLIGHT[5]]
    set_property IOSTANDARD LVCMOS33 [get_ports 7SEGLIGHT[5]]
set_property PACKAGE_PIN U7 [get_ports 7SEGLIGHT[6]]              
    set_property IOSTANDARD LVCMOS33 [get_ports 7SEGLIGHT[6]]
set_property PACKAGE_PIN V7 [get_ports 7SEGLIGHT[7]]                    
    set_property IOSTANDARD LVCMOS33 [get_ports 7SEGLIGHT[7]]
